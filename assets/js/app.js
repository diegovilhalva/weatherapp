...
export const uptadeWeather =  function (lat,lon) {
   loading.style.display = "grid"
    ...
    fetchData(url.currentWeather(lat,lon), function (currentWeather) {
        ...
        fetchData(url.airPollution(lat,lon), function (airPollution) {
            ...
            card.innerHTML  = `
            <h2 class="title-2" id="highlights-label">Previsão por hora</h2>
            <div class="highlight-list">
                <div class="card card-sm highlight-card one">
                    <h3 class="title-3">Qualidade do Ar</h3>
                    <div class="wrapper">
        ...
        fetchData(url.forecast(lat,lon),function (forecast) {
            ...
            for (const [index,data] of forecastList.entries()) {
                ...
                <p class="body-3">${(module.getHours(dateTimeUnix,timezone))}</p>
                 <img src="assets/images/weather_icons/${icon}.png" width="48" height="48" loading="lazy" class="weather-icon" alt="${description}" title="${description}">
                ...
                <div class="card card-sm slider-card">
                    <p class="body-3">${(module.getHours(dateTimeUnix,timezone))}</p>
                    <img src="assets/images/weather_icons/direction.png" alt="" title="" loading="lazy" width="48" height="48" class="weather-icon" style="transform: rotate(${windDirection - 180 }deg);">
                    <p class="body-3">${parseInt(module.mph_to_kmh(windSpeed))} km/h</p>
                </div>
            `
            ...
            for (let i = 7 ,len = forecastList.length; i < len ; i += 8) {
                ...
                <p class="label-1">    ${module.weekDayNames[date.getUTCDay() - 1]}</p>
                `
